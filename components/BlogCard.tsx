...
export default function BlogCard(props){
    ...
    return (
        <div className="overflow-hidden shadow-2xl rounded-lg h-120 w-120 md:w-88 cursor-pointer m-auto">
                ...
                <a className="w-full block h-full">
                    <div className='overflow-hidden'>
                        <img alt={props.post.title} src={props.post.display} title={props.post.title} className={
                                hover ? "blogcard-image active max-h-60 w-full object-cover transition ease-out duration-1500" : "blogcard-image max-h-60 w-full object-cover transition ease-out duration-1500"
                            }
