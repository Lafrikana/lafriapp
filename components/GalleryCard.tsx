        ...
        <div className="gallery-item relative">
            {
                props.type == "image" ?
                    <>
                        <img src={props.file} className="img-responsive h-full" data-description={props.description} data-date={convertDate(props.date, "PPP")} alt={props.description}/>
                ...
                : <video className="vid">
                    <source src={props.file}
                        type="video/mp4" data-description={props.description} data-date={convertDate(props.date, "PPP")}>
                    </source>
                </video>
            }
        </div>
