    ...
    return (
        <Layout env='blog'>
            ...
            <div className='article-window w-full grid lg:grid-cols-3'>
                <article className="bg-white self-center align-center mx-auto px-6 w-full lg:my-4 max-w-2xl lg:max-w-3xl prose prose-xl dark:prose-dark lg:col-span-2">
                ...
                <div className='mx-auto px-6 w-full pt-8 mt-4 lg:mt-0 lg:pt-0 border-t-2 border-gray-200 lg:border-0'>
